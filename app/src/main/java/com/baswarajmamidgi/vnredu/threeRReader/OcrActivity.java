...
/*
    ...
    */
    ...
    public File stringtopdf(String data) throws DocumentException {
        String extstoragedir = Environment.getExternalStorageDirectory().toString();
        File fol = new File(extstoragedir, "3RReader");
    ...
    private void savaImage(String filename) throws IOException {
        File fol = new File(Environment.getExternalStorageDirectory(), "3RReader");
    ...
    private void sharepdf() throws DocumentException {
    ...
    private void saveFileToDrive() throws DocumentException {
