...
public class SavedFiles extends AppCompatActivity implements AbsListView.MultiChoiceModeListener {
   private ArrayList<String> offlinefiles=new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        File directory=new File(Environment.getExternalStorageDirectory(),"3RReader/pdf");
        if(directory.exists()) {
    ...
    {
        File file=new File(Environment.getExternalStorageDirectory()+"/3RReader/pdf/"+filename);
        ...
        switch (item.getItemId()) {
            case R.id.action_delete: {
                for (String itemname : toDelete) {
                    ...
                    File file = new File(Environment.getExternalStorageDirectory() + "/3RReader/pdf/" + itemname);
                    if (file.delete()) {
            ...
            case R.id.action_share: {
                    ...
                    File file = new File(Environment.getExternalStorageDirectory() + "/3RReader/pdf/" + toDelete.get(0));
